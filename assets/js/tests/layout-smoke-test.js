(function(){
  const requiredIds = ['menu','flashcards','quiz','finditem','memory','articulos','wordsearch','spelling','balloons','catGrid','badgeShelf','achievementsCard','starProgressBar','recentRewardCard','qSumReview','qMistakeList','qMistakeSuccess','qMistakeInfo','qMistakeCount','qSummaryTitle'];
