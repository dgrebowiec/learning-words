...
const ALL_SECTIONS = ['menu','flashcards','wordlist','quiz','finditem','memory','articulos','wordsearch','spelling','scramble','repeat','timerace','tamagotchi','balloons','catchword','opposites'];
